...
export const NOTE_PATTERNS: Array<{
...
}> = [
  {
    ...
    patternClass: "",
    previewClass: "bg-white border-2 border-gray-300",
  },
  {
    id: "dots",
    label: "Dots",
    ...
    previewClass: "bg-pattern-dots bg-white",
  },
  {
    id: "grid",
    label: "Grid",
    ...
    previewClass: "bg-pattern-grid bg-white",
  },
  {
    id: "diagonal",
    label: "Diagonal",
    ...
    previewClass: "bg-pattern-diagonal bg-white",
  },
  {
    id: "waves",
    label: "Waves",
    ...
    previewClass: "bg-pattern-waves bg-white",
  },
  {
    id: "circles",
    label: "Circles",
    ...
    previewClass: "bg-pattern-circles bg-white",
  },
];
